...
- (IBAction)myAlertClick:(id)sender {
    ...
    LXAlertView *alert=[[LXAlertView alloc] initWithTitle:@""andHeadImage:@"side_play@2x" message:@"不要错过萌小希精心为你挑选的内容哦~是否允许推送？" cancelBtnTitle:@"去开启" otherBtnTitle:@"残忍拒绝" clickIndexBlock:^(NSInteger clickIndex) {
